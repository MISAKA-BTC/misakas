...
impl RpcApi for GrpcClient {
    ...
    route!(get_utxos_by_address_page_call, GetUtxosByAddressPage);
    ...
    route!(get_palw_claims_call, GetPalwClaims);
    route!(get_palw_classes_call, GetPalwClasses);
    ...
    route!(get_palw_vesting_call, GetPalwVesting);
