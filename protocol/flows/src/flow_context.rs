...
mod tests {
    ...
    fn a_peer_kept_below_the_fence_is_dropped_when_this_node_reaches_it() {
        ...
        // The 2400 day's builds: ADR-0114's 3500 was scheduled later and is not theirs — nor are the
        // 2026-09-11 audit fences (4000 shallow, 7000 deep), scheduled later still.
