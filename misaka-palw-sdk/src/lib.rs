...
mod tests {
    ...
    fn a_fused_row_preflights_under_the_court_the_ruleset_arms_and_not_without_it() {
        ...
        let dormant = PalwAdmissionShapeV1 { court: None, ladder: None, token_lift: false };
    ...
    fn a_fused_row_preflights_under_t11s_court_with_the_ladder_dormant() {
        ...
        let with_rules = PalwAdmissionShapeV1 { court: Some(court), ladder: Some(rules), token_lift: false };
