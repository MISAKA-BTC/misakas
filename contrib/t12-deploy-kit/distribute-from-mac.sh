...
#   ./distribute-from-mac.sh binaries   5.104:/root/t12-rel/incoming/$REV → Mac (cache) → ibm, .113
#                                       (the release's misaka-dnsseeder lands in the Mac cache too, for
#                                        seeders/20-stage.sh if the operator chooses to swap seeders)
