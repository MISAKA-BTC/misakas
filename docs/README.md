...
- [The DAA 6,301 PALW upgrade and Verification V2 at 6,400](testnet11-6301-upgrade-announcement.md) — what fires at 6,300, 6,001, 6,100, 6,201 and 6,900, and what an operator must do before 6,000
- [Pre-arming security audit of the DAA 6,301 bundle (2026-09-18)](palw-audit-2026-09-18-6001.md) — two Critical and six High findings, the seven release blockers and their fixes, and what is left as residual risk
- [The DAA clock under the 6,301 bundle (2026-09-18)](palw-daa-clock-audit-2026-09-18.md) — every lane's effect on the DAA score, `bits` and blue work; the window arithmetic at 120 s / measured / max lane load; the blocker and its fix (ADR-0138)
