...
| 0087 D3 — two objects on carriers are the only moves; D8 — the surfaces; §1 — "the EVM lane is an optional, non-default feature" | amended (design, PROPOSED 2026-09-05): the same two moves can be made from the EVM through a writer whose actions the fold applies after the block; the surfaces gain three read precompiles and a per-class MRC-20 facade; the premise is stale (the lane is a default build) | [0089](0089-the-fold-is-the-truth-and-the-evm-is-its-window-and-its-hand.md) D5–D7 |
