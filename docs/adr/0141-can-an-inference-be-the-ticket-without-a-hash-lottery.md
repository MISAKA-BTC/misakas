...
block is admitted when that digest falls under a target. Past 6,301 the target is `CCU / W` — the
...
**D4. Nothing here is scheduled.** No fence, no height, no dependency for the 6,301 bundle.
