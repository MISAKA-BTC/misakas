...
| | |
|---|---|
| a `kaspad` from `main` | on the network's current ruleset — its first log lines print fingerprint `3d150afd18d2367a1ed0de65d0b1c12cfe06cd8a61478354ecab27e6283855e1` and fence schedule `1150, 1900, 2150, 2400, 3500, 4000, 6000, 6001, 6201, 6900, 2125000`; see [testnet11-join-mining.md](testnet11-join-mining.md) §1 |
