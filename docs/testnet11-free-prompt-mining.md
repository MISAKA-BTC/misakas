...
| | |
|---|---|
| a `kaspad` from `main` | on the network's current ruleset — its first log lines print fingerprint `135b6ee07ba0c5e5951c3cb765ba9dfec8b85af4c6edccc5a2246a52338e766b` and fence schedule `1150, 1900, 2150, 2400, 3500, 4000, 6000, 6001, 6201, 6900, 2125000`; see [testnet11-join-mining.md](testnet11-join-mining.md) §1 |
