...
| | |
|---|---|
| a `kaspad` from `main` | on the network's current ruleset — its first log lines print fingerprint `7920f7b233695172959046ce2d7c18cc58729753a3cbc90d0b4ba27c8ec3c30f` and fence schedule `1150, 1900, 2150, 2400, 3500, 4000, 6300, 6301, 6501, 6900, 2125000`; see [testnet11-join-mining.md](testnet11-join-mining.md) §1 |
