...
| | |
|---|---|
| a `kaspad` from `main` | on the network's current ruleset — its first log lines print fingerprint `b16a94770653183bce23c8c184f58e1326e4d9ba5e1b32d51c4e9511a08638be` and fence schedule `1150, 1900, 2150, 2400, 3500, 4000, 6300, 6301, 6501, 6900, 2125000`; see [testnet11-join-mining.md](testnet11-join-mining.md) §1 |
