...
| | |
|---|---|
| a `kaspad` from `main` | on the network's current ruleset — its first log lines print fingerprint `32c2e8e3e5c8296e985e0fbbe4cdf382191782b52a9a328c72f91b3183a87932` and fence schedule `1150, 1900, 2150, 2400, 3500, 4000, 6000, 6001, 6201, 6900, 2125000`; see [testnet11-join-mining.md](testnet11-join-mining.md) §1 |
