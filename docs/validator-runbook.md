...
Validators attest for the DNS stake reorg gate and are paid 20 % of the block subsidy from the height the network schedules (ADR-0126, revised); PALW block production and settlement do not depend on validators.
