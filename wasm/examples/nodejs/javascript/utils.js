...
function parseArgs(options = {
    ...
    if (values.help) {
        console.log(`Usage: node ${script} [address] [testnet-200|mainnet] [--address <address>] [--network <testnet-200|mainnet>] [--encoding <borsh|json>] ${options.additionalHelpOutput}`);
        process.exit(0);
    }
