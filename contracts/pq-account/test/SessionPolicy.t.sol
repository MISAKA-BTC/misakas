...
contract SessionPolicyTest is Test {
        ...
        returns (bytes memory)
    {
        ...
        bytes32 opHash = keccak256(
            abi.encode(domain, block.chainid, address(account), VERSION, tgt, value, keccak256(callData), callIndex)
        );
    ...
    function test_proof_single_leaf_happy() public {
        ...
        account.executeSessionWithProof(address(nft), 0, cd, 0, _sessionSig(address(nft), 0, cd, 0), l, proof);
    ...
    function test_proof_two_leaf_happy_and_bad_proof() public {
        ...
        account.executeSessionWithProof(address(nft), 0, cd, 0, _sessionSig(address(nft), 0, cd, 0), lNft, proofN);
        ...
        account.executeSessionWithProof(address(nft), 0, cd, 1, _sessionSig(address(nft), 0, cd, 1), lNft, bad);
    }
    ...
    function test_proof_leaf_call_mismatch_reverts() public {
        ...
        account.executeSessionWithProof(address(erc20), 0, cd, 0, _sessionSig(address(erc20), 0, cd, 0), l, proof);
    }
    ...
    function test_proof_codehash_pin_ok_and_mismatch() public {
        ...
        account.executeSessionWithProof(address(nft), 0, cd, 0, _sessionSig(address(nft), 0, cd, 0), lBad, proof);
    }
    ...
    function test_proof_erc721_vs_erc20_collision_same_selector() public {
        ...
        account.executeSessionWithProof(address(nft), 0, cdN, 0, _sessionSig(address(nft), 0, cdN, 0), lNft, proofN);
        ...
        account.executeSessionWithProof(address(erc20), 0, cdE, 1, _sessionSig(address(erc20), 0, cdE, 1), lErc, proofE);
    }
    ...
    function test_proof_erc721_tokenid_pin_rejects_wrong_id() public {
        ...
        account.executeSessionWithProof(address(nft), 0, cdBad, 0, _sessionSig(address(nft), 0, cdBad, 0), l, proof);
        bytes memory cdOk = abi.encodeWithSelector(SEL_TRANSFER_FROM, address(account), address(0xBEEF), uint256(42));
        account.executeSessionWithProof(address(nft), 0, cdOk, 0, _sessionSig(address(nft), 0, cdOk, 0), l, proof);
    ...
    function test_explicit_erc721_count_cap() public {
        ...
        for (uint256 i; i < 2; i++) {
            ...
            account.executeSession(address(nft), 0, cd, uint64(i), _sessionSig(address(nft), 0, cd, uint64(i)));
        }
        ...
        account.executeSession(address(nft), 0, cd3, 2, _sessionSig(address(nft), 0, cd3, 2));
    }
    ...
    function test_explicit_erc1155_amount_and_id() public {
        ...
        account.executeSession(address(nft), 0, cdWrongId, 0, _sessionSig(address(nft), 0, cdWrongId, 0));

        // over per-call -> cap
        bytes memory cdOver = abi.encodeWithSelector(SEL_1155, address(account), address(0xBEEF), uint256(5), uint256(11), bytes(""));
        vm.expectRevert("PQ: token amount cap");
        account.executeSession(address(nft), 0, cdOver, 0, _sessionSig(address(nft), 0, cdOver, 0));
        ...
        account.executeSession(address(nft), 0, cdOk, 0, _sessionSig(address(nft), 0, cdOk, 0));
        ...
        account.executeSession(address(nft), 0, cd6, 1, _sessionSig(address(nft), 0, cd6, 1));
    }
    ...
    function test_explicit_erc1155_batch_rejected() public {
        ...
        account.executeSession(address(nft), 0, cd, 0, _sessionSig(address(nft), 0, cd, 0));
    }
    ...
    function test_explicit_erc20_cumulative_total_cap() public {
        ...
        account.executeSession(address(erc20), 0, cd60, 0, _sessionSig(address(erc20), 0, cd60, 0));
        bytes memory cd60b = abi.encodeWithSelector(SEL_TRANSFER, address(0xBEEF), uint256(60));
        vm.expectRevert("PQ: token total cap");
        account.executeSession(address(erc20), 0, cd60b, 1, _sessionSig(address(erc20), 0, cd60b, 1));
    }
    ...
    function test_permit2_target_denied() public {
        ...
        account.executeSession(PERMIT2, 0, cd, 0, _sessionSig(PERMIT2, 0, cd, 0));
    }
