...
fn honest_floor_attempts_have_no_identity_or_output_fault() {
    ...
    for form in [PalwPromptIdsFormV1::Flat, PalwPromptIdsFormV1::MerkleV1] {
        ...
        let rules = PalwIdentityRulesV1 { prompt_ids_form: form, base_class_id: class_id };
        let as_model = PalwIdentityRulesV1 { prompt_ids_form: form, base_class_id: Hash64::from_u64_word(0xB45E) };
