...
//!
//! * `drill --family <base0|qwen36|a16|a16-v5|qwen36-v6> --lane <attempt|fp> --out <file>` runs the family's
...
fn usage() -> ! {
    eprintln!(
        "usage:\n  \
         palw-certify drill (--family <base0|qwen36|a16|a16-v5|qwen36-v6> | --model-id <catalog model id>) --lane <attempt|fp> --out <file>\n  \
