...
/// ADR-0097's `palw_model_fit_v1::stand_ins::KIMI_K3_TOTAL_PARAMETERS`, restated here because
/// ADR-0097 lives on `feat/adr-0097-model-fit` and this generator was cherry-picked onto `main`
/// without it. Import it again once that module lands.
const KIMI_K3_TOTAL_PARAMETERS: u64 = 2_800_000_000_000;
