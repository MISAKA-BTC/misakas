...
mod tests {
    ...
    use crate::palw_state_v2::{
        PalwBlockContextV2, PalwChainStateV2, PalwClassDaaV2Params, PalwConsensusObjectV2, PalwPanelSeatV2, PalwPwuRuleV2,
    ...
    fn certified_state(initial_target: u128) -> PalwChainStateV2 {
        ...
        let license = PalwConsensusObjectV2::ReceiptLicensed { claim: h64(0xFC) };
