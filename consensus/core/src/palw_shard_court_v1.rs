...
/// accusation and a leaf's evidence disclosed to the held DA court (ADR-0108 Decision 1): one
...
/// **A leaf's evidence** (ADR-0108 Decision 1) — a `ShardCourtAccused` accusation's content
