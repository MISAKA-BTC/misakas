...
pub fn certify_e2e_family_v1(evidence: &PalwE2eDrillEvidenceV1) -> Result<PalwE2eCertificateV1, PalwE2eError> {
    ...
    for vector in &evidence.vectors {
        ...
        let operands =
            crate::palw_artifact::PalwProvenOperandsV1::from_openings_v1(&vector.operand_openings, evidence.artifact_root)
...
const PALW_RC_COURT_E2E_ROOT_BYTES: [u8; 64] = [
    0xae, 0x0d, 0xcd, 0xf6, 0x86, 0xda, 0x8e, 0x1e,
    0x2b, 0x53, 0xbd, 0xcd, 0xb2, 0xf5, 0x3f, 0x06,
    0x9d, 0xee, 0x1d, 0x40, 0x29, 0x5a, 0x4e, 0xb9,
    0x06, 0x9f, 0x11, 0x5d, 0xdb, 0xed, 0xd2, 0x99,
    0xed, 0xdb, 0x12, 0xdb, 0x01, 0x08, 0xb1, 0x78,
    0xc9, 0xe7, 0xe2, 0x98, 0xb8, 0xd6, 0x57, 0x8a,
    0xcf, 0xc5, 0xb9, 0x2e, 0x31, 0x6a, 0xd6, 0x9a,
    0x31, 0x50, 0xac, 0x6c, 0xce, 0x80, 0x51, 0xe1,
];
