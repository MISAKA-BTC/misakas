...
mod tests {
    ...
    // kaspa-pq Phase 9: MerkleRoot widened to Hash64 per ADR-0008. The pinned
    // vectors below are the regenerated 64-byte (128 hex) merkle roots produced
    // by the keyed BLAKE2b-512 `MerkleBranchHash64` hasher.
    #[test]
    fn merkle_root_test() {
        let txs = [
            Transaction::new(
        ...
        assert_eq!(
            ...
            Hash64::from_str("32a59af5b8cafcf318301b9bc07e05a9a1b2fabd1025b4b01fa58f3e5bd360be6778b6c0f84da3fe8f03400dcb9cb6c7b3788f425cd233a2a63c48785b616234")
                .unwrap()
        );
        ...
        assert_eq!(
            calc_hash_merkle_root(txs.iter()),
            Hash64::from_str("f97ee37af98db6bfec2ac914a1a8124c67fd48b04e3ce0d922e97e1847f28d2f9415afb8d14220bb619b334b04c6942fc2ce08910d3456c80e6de2f08181193d")
                .unwrap()
        );
