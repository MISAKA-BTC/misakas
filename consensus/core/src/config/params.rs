...
mod consensus_params_id_tests {
    ...
    fn shipped_presets_have_pinned_fingerprints() {
        ...
        let changed: Vec<String> = [
            ...
            // Moved 2026-08-14 by the t10 unwedge: `dns_veto_ttl_daa_score` 6_000 -> 2_000 in
            // TESTNET_DNS_PARAMS. Testnet only — the other three are untouched, which is the
            // check that the edit stayed scoped. Nodes on 5fabb683… will NOT peer with this.
            ("testnet", TESTNET_PARAMS, "a1e6602e87a046fd0d2c56a943d2b188a2d41cb71c02979aa3a9561411802d1f"),
