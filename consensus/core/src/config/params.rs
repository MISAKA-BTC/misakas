...
pub const MAINNET_PARAMS: Params = Params {
    ...
    // table in `SUBSIDY_BY_MONTH_TABLE` (18B over 20 years at 5%/yr) applies from
    ...
    // = 444_562_014 sompi ≈ 4.44562 KAS) so callers reading it see the genesis rate.
    deflationary_phase_daa_score: 0,
    pre_deflationary_phase_base_subsidy: 444562014,
