...
///   allocation** on the `misaka-t12-community` sentinel txid
///   ([`config::premine::TESTNET12_COMMUNITY_ALLOCATIONS`], 16 UTXOs) = MuHash over
///   `config::premine::genesis_premine_utxos_for(testnet-12)`.
/// * Everything structural is [`PALW_RC_GENESIS`]'s: `bits` at the easiest representable target
///   (one attempt is one full pinned-LLM inference, so a hash-miner's start bits would never find a
///   block), the shared reference timestamp, `daa_score` 0.
///
...
pub const PALW_T12_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xf6, 0xcc, 0x95, 0x76, 0x86, 0xf7, 0x04, 0x7d, 0xc9, 0xfe, 0x6c, 0x96, 0x19, 0xd8, 0xf4, 0x87, 0x23, 0x75,
        0x74, 0xb0, 0x59, 0x65, 0x73, 0xaf, 0x9d, 0x33, 0x7c, 0x8f, 0x1f, 0x19, 0x80, 0x15, 0x1b, 0x26, 0x25, 0x69,
        0x67, 0xa9, 0xa8, 0x1f, 0x7a, 0xe3, 0x1a, 0x5a, 0x35, 0x2e, 0x24, 0x9d, 0xd5, 0x42, 0x6c, 0x0c, 0xe9, 0x14,
        0x4f, 0x75, 0xeb, 0x26, 0xa3, 0xca, 0x3a, 0x96, 0x3a, 0x30,
    ]),
    hash_merkle_root: Hash64::from_bytes([
    ...
    utxo_commitment: Hash64::from_bytes([
        0x11, 0x66, 0x9b, 0xc6, 0x40, 0x3c, 0xd6, 0x7f, 0x6c, 0x74, 0x3b, 0x00, 0xcf, 0x6a, 0x50, 0x59, 0xe5, 0x63,
        0x93, 0x26, 0xd1, 0x2e, 0x42, 0xd1, 0xde, 0xc4, 0x73, 0x45, 0xf0, 0x35, 0x9c, 0xba, 0x4e, 0xd7, 0x01, 0x57,
        0x2a, 0x85, 0xd4, 0xd5, 0x79, 0x4e, 0x17, 0x63, 0x9a, 0xc6, 0x0e, 0xba, 0xcf, 0x46, 0xbe, 0x22, 0x4e, 0x80,
        0x42, 0xdb, 0xa7, 0x78, 0xf2, 0xcc, 0xf4, 0xc0, 0xc6, 0x7d,
    ]),
    #[rustfmt::skip]
    coinbase_payload: &[
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Blue score
