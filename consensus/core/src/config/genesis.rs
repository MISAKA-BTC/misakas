...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    ...
    hash: Hash64::from_bytes([
        0x07, 0xc0, 0xa3, 0x4e, 0x19, 0xd2, 0xee, 0xc6, 0x19, 0x93, 0x40, 0x9d, 0x47, 0xc4, 0xcf, 0xeb, 0xb7, 0xd6, 0x74, 0x35,
        0x9a, 0xf0, 0x2c, 0xeb, 0x62, 0x43, 0x1b, 0xfe, 0x3c, 0x9e, 0x02, 0x95, 0x92, 0x1c, 0x74, 0x72, 0x03, 0xf0, 0xa5, 0x5d,
        0x3c, 0x14, 0xbc, 0x0a, 0xe2, 0xdf, 0x6c, 0x61, 0x35, 0xb1, 0xe0, 0x45, 0x99, 0x85, 0x36, 0x4e, 0xae, 0x31, 0x2e, 0x95,
        0x76, 0x28, 0x7d, 0xf1,
    ]),
    hash_merkle_root: Hash64::from_bytes([
        0x3e, 0xa0, 0xac, 0xc9, 0x16, 0xda, 0xd0, 0xd5, 0x2d, 0xa2, 0xdc, 0x61, 0x11, 0xf9, 0x17, 0x4a, 0xa1, 0xa0, 0x25, 0x8e, 0x3b,
        0x44, 0x29, 0xa5, 0x79, 0x10, 0xa8, 0x88, 0xa8, 0xe4, 0xf3, 0xc0, 0x9c, 0x00, 0x48, 0x2a, 0x9f, 0x1a, 0xff, 0x5a, 0xc5, 0x46,
        0x34, 0xd2, 0x4e, 0xdf, 0x41, 0x80, 0x50, 0xf4, 0xcc, 0x50, 0xe9, 0xc1, 0x2f, 0xb3, 0x2f, 0x5f, 0x24, 0x27, 0x3b, 0x1e, 0xbe,
        0x5a,
    ]),
    // The 10B-cap re-genesis (2026-08-30, "Relaunch 3"): commits to EXACTLY 10B MSK = the main
    // wallet, minus the carve-outs it pays for — six 10,000-MSK genesis-bond collateral outputs (ADR-0061) (at
    // the bonds' own outpoint indices, owned by the main wallet's key), six 100-MSK fee floats,
    ...
    utxo_commitment: Hash64::from_bytes([
        0x15, 0x7e, 0x3f, 0xf2, 0x7e, 0x7e, 0x24, 0x74, 0x8f, 0xfa, 0x02, 0xe2, 0xfb, 0x53, 0x5a, 0x7a, 0x08, 0xaa, 0x70, 0xb5,
        0x8a, 0xb7, 0xbe, 0xa9, 0x43, 0xb9, 0x48, 0xbd, 0xfd, 0xce, 0xbb, 0xb8, 0x26, 0x64, 0xf3, 0x4a, 0x50, 0xda, 0xd4, 0xd8,
        0x88, 0x3e, 0x7f, 0xdc, 0x85, 0x9e, 0xeb, 0x08, 0xe1, 0x88, 0xf7, 0xb6, 0x6e, 0xf7, 0x5a, 0xc5, 0x56, 0x23, 0x10, 0xc0,
        0x9a, 0x28, 0x8d, 0xec,
    ]),
    ...
    coinbase_payload: &[
        ...
        // "misaka-testnet"
        0x6d, 0x69, 0x73, 0x61, 0x6b, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74,
        // TN11, kaspa-pq Relaunch 3: the 10B-cap re-genesis (2026-08-30; Relaunch 2 was the
        // community-allocation public relaunch of 2026-08-20). The bump makes this chain
        // cryptographically distinct from its predecessor — an un-wiped node hits the startup
        // genesis-mismatch guard instead of silently resuming.
        11, 3,
    ],
    ..TESTNET_GENESIS
};
...
pub const PALW_RC_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x4b, 0x61, 0x9a, 0x1a, 0xc5, 0xfd, 0x76, 0xe7, 0xa9, 0xb5, 0xbf, 0x1d, 0x53, 0x9c, 0x52, 0x4f, 0xb7, 0xfc, 0x84, 0x2c, 0xde,
        0x69, 0xc4, 0x5f, 0x20, 0xac, 0xf0, 0xb6, 0x9b, 0x04, 0x76, 0xcc, 0xea, 0x04, 0x81, 0x1a, 0x8f, 0x17, 0x59, 0xe8, 0xcd, 0x2d,
        0x61, 0x83, 0x00, 0x7d, 0x03, 0x83, 0xf7, 0x97, 0x4a, 0x44, 0x52, 0x9f, 0x60, 0x9d, 0x72, 0x32, 0x06, 0x61, 0x14, 0x49, 0xc2,
        0x15,
    ]),
    version: 0,
    hash_merkle_root: Hash64::from_bytes([
    ...
    utxo_commitment: Hash64::from_bytes([
        0x67, 0x0b, 0x11, 0x25, 0xa3, 0xcf, 0x4e, 0x62, 0xed, 0xe9, 0xed, 0x34, 0x0a, 0x3f, 0x81, 0x8d, 0xc9, 0xa1, 0x15, 0xf6, 0xb1,
        0x5b, 0x46, 0xb0, 0xb7, 0x8f, 0xde, 0x1a, 0x39, 0xb9, 0xd2, 0x0f, 0xb1, 0xb9, 0xfa, 0xc0, 0x30, 0x41, 0x63, 0x6a, 0xf5, 0xf6,
        0x46, 0xd4, 0x95, 0x5c, 0xd1, 0x69, 0x38, 0xb0, 0x3e, 0x8b, 0xfb, 0x09, 0x17, 0x46, 0xca, 0xd4, 0x3d, 0xaa, 0x45, 0xc0, 0x3f,
        0x7f,
    ]),
    timestamp: 1748390400000,
    bits: 0x207fffff,
...
mod tests {
    ...
    fn every_genesis_commits_to_the_premine_this_build_mints() {
        ...
        let cases: [(&str, NetworkId, &GenesisBlock); 5] = [
            ...
            ("testnet-11", NetworkId::with_suffix(NetworkType::Testnet, 11), &TESTNET11_GENESIS),
