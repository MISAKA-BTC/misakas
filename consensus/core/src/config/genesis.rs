...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x5e, 0xfc, 0x45, 0xc6, 0xec, 0xd3, 0xd2, 0x54, 0x4d, 0x5f, 0x94, 0x84, 0x8b, 0xfc, 0x6b, 0x23, 0x54, 0x31, 0xe2, 0x13, 0xc1,
        0x21, 0x63, 0xf3, 0x44, 0xa3, 0x73, 0x7a, 0x88, 0x7c, 0x39, 0x58, 0x21, 0x68, 0x9a, 0x2d, 0xe7, 0x08, 0x21, 0x96, 0x6b, 0x57,
        0xbf, 0x08, 0x9c, 0x1d, 0x37, 0xe0, 0x9a, 0x89, 0x1a, 0xbe, 0x05, 0x87, 0x98, 0xd4, 0xa1, 0x42, 0x40, 0xbc, 0x93, 0x32, 0x53,
        0x1f,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    ...
    timestamp: 1748390400000,
    // kaspa-pq Phase 2 (ADR-0007): eased to `0x1f7fffff` for the memory-hard
    // Argon2id 16 MiB migration — see the GENESIS (mainnet) note above.
    bits: 0x1f7fffff,
    nonce: 0,
    daa_score: 0,
    #[rustfmt::skip]
...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xa4, 0x45, 0xda, 0xa8, 0x8c, 0x9c, 0x2d, 0xf7, 0xd6, 0x8a, 0x52, 0x01, 0x43, 0x5a, 0x14, 0xb7, 0x9c, 0x39, 0xb5, 0xb6, 0x25,
        0x5f, 0x6a, 0x98, 0xca, 0x98, 0xa3, 0xc5, 0x9d, 0x11, 0x5c, 0x49, 0xbb, 0xf8, 0x8e, 0x8a, 0x9f, 0x73, 0x5f, 0x52, 0x3b, 0xc2,
        0x97, 0x74, 0x7b, 0xeb, 0xc8, 0x63, 0x5f, 0xd5, 0x7d, 0xbc, 0x23, 0x91, 0xac, 0x91, 0x03, 0x39, 0x29, 0xf2, 0x03, 0x86, 0x08,
        0x9e,
    ]),
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
    ...
    bits: 520932556, // see `gen_testnet11_genesis` (rescaled after the Phase-2 Argon2id testnet bits ease)
    #[rustfmt::skip]
    coinbase_payload: &[
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Blue score
        0x00, 0xE1, 0xF5, 0x05, 0x00, 0x00, 0x00, 0x00, // Subsidy
