...
// UTXO locked to the 2-of-3 ML-DSA-65 multisig P2SH (see
...
pub const GENESIS: GenesisBlock = GenesisBlock {
    ...
    hash: Hash64::from_bytes([
        0xc6, 0xe3, 0x96, 0x02, 0x3f, 0xf2, 0xbe, 0xa5, 0x4f, 0x93, 0x80, 0x25, 0x45, 0x6f, 0x78, 0xdd, 0xb2, 0xc3, 0x6c, 0x76, 0x80,
        0xec, 0x23, 0x77, 0xbe, 0xc1, 0xed, 0x4d, 0xfc, 0xd1, 0xe4, 0x55, 0x09, 0xf2, 0xea, 0x71, 0x55, 0x0c, 0xb4, 0x10, 0x3c, 0x2d,
        0x5d, 0xcf, 0x0c, 0xa1, 0x78, 0x1d, 0x5b, 0x56, 0x84, 0xa9, 0xd7, 0x1a, 0xef, 0xf8, 0xb4, 0xd0, 0xf0, 0xf0, 0xdb, 0x1a, 0xc1,
        0x09,
    ]),
    version: 0,
    ...
    // kaspa-pq: genesis commits to the 15B premine UTXO (2-of-3 ML-DSA-65 multisig
    // P2SH); = MuHash over `config::premine::misaka_premine_utxos()`. Same on all nets.
    utxo_commitment: Hash::from_bytes([
        0x9f, 0xf7, 0xcc, 0xfb, 0xe3, 0xcf, 0x01, 0x42, 0x1b, 0x00, 0xef, 0x4a, 0x99, 0xf5, 0x7c, 0xf5, 0xa1, 0xcb, 0xce, 0x7d, 0xe4,
        0xe4, 0xa5, 0xdb, 0x5f, 0xc8, 0xb9, 0x11, 0xae, 0xc8, 0x0b, 0xa4,
    ]),
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xc5, 0x0d, 0x4b, 0xb1, 0x07, 0x5d, 0x12, 0x76, 0x68, 0x5c, 0xad, 0x3f, 0xef, 0xb9, 0x0c, 0x5e, 0x00, 0xff, 0x94, 0x39, 0x42,
        0x97, 0x96, 0x64, 0x2c, 0x07, 0xf8, 0x78, 0xac, 0xf8, 0xe2, 0xaf, 0x2c, 0x57, 0xa3, 0xd7, 0x6f, 0x3d, 0x5b, 0x76, 0x4e, 0xca,
        0xe7, 0x20, 0x35, 0x45, 0x43, 0x1a, 0x68, 0x9a, 0x1e, 0x62, 0xe7, 0x2c, 0xe1, 0x9e, 0xb4, 0xc0, 0xc5, 0xaa, 0x18, 0x02, 0xc5,
        0x8b,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xfd, 0x97, 0x6c, 0x39, 0x75, 0xa4, 0xb7, 0xe9, 0x13, 0x2d, 0x60, 0x8d, 0xa1, 0x1d, 0xb8, 0x34, 0x06, 0x6a, 0x73, 0x6a, 0xf0,
        0x51, 0x06, 0x2d, 0xdf, 0x55, 0xdb, 0xb4, 0x78, 0x90, 0x56, 0x18, 0xbe, 0xea, 0xcc, 0xfc, 0x2a, 0xa4, 0x48, 0xba, 0x67, 0x46,
        0x20, 0x1d, 0xfc, 0x17, 0xc2, 0x8f, 0x70, 0x67, 0xf9, 0x3f, 0x08, 0xf3, 0x8e, 0x0b, 0x60, 0xc1, 0x2c, 0x3c, 0x17, 0x2f, 0x63,
        0x0b,
    ]),
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x95, 0xc4, 0x68, 0xe0, 0x26, 0xb3, 0x80, 0xf5, 0xd2, 0x73, 0x35, 0x70, 0x61, 0xbe, 0x0d, 0x49, 0xed, 0xf3, 0x49, 0xf9, 0x39,
        0x8f, 0xce, 0x2e, 0x04, 0x3b, 0xed, 0x41, 0x6c, 0xd3, 0x3c, 0x7b, 0x8e, 0x26, 0xd2, 0x03, 0x93, 0x6d, 0x28, 0xf9, 0x08, 0x9a,
        0x65, 0x3a, 0xcb, 0xaf, 0x52, 0x8e, 0x65, 0x8a, 0x28, 0x8e, 0x85, 0x01, 0x18, 0xdd, 0xe0, 0xd9, 0x86, 0x64, 0x82, 0xc9, 0xca,
        0x00,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xe4, 0x3f, 0xfe, 0xbd, 0x64, 0xe2, 0x31, 0xf0, 0xb1, 0x83, 0x42, 0x21, 0x12, 0x62, 0xa4, 0xd4, 0x0a, 0x1a, 0xd8, 0x0d, 0x52,
        0x33, 0x40, 0xae, 0x4d, 0x06, 0x06, 0x35, 0x2b, 0x2f, 0x0d, 0x79, 0x75, 0x9e, 0x74, 0xee, 0xba, 0xa9, 0x3c, 0x30, 0x11, 0xe1,
        0xdc, 0xd9, 0x9b, 0x13, 0xd6, 0x96, 0x72, 0x84, 0xb9, 0x9c, 0x49, 0xc9, 0x5c, 0x85, 0x28, 0xcc, 0xa5, 0x03, 0x6a, 0x9f, 0xb7,
        0xd9,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
