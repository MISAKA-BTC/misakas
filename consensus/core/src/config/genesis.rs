...
//
// `utxo_commitment` commits to the kaspa-pq genesis premine: a single 12B KAS
...
pub const GENESIS: GenesisBlock = GenesisBlock {
    ...
    hash: Hash64::from_bytes([0x0a, 0xea, 0x62, 0x08, 0x3b, 0xf7, 0x48, 0xc3, 0x4d, 0x17, 0x07, 0xb7, 0x22, 0xcd, 0x4b, 0x11, 0x0a, 0x9c, 0xeb, 0x95, 0x8c, 0x2f, 0xa4, 0x0a, 0x81, 0x19, 0x90, 0x35, 0x47, 0x69, 0xe6, 0x01, 0x0e, 0xf0, 0x10, 0xf9, 0x7a, 0x34, 0x9c, 0xeb, 0xa0, 0x7e, 0x4d, 0x67, 0x13, 0x10, 0x4b, 0x9f, 0x2f, 0xd3, 0x91, 0x8b, 0xcf, 0xf5, 0xcf, 0x6e, 0x87, 0x8a, 0xdc, 0xa9, 0xe9, 0xc8, 0x24, 0xa0]),
    version: 0,
    ...
    // kaspa-pq (audit H-01): genesis commits to the 12B premine UTXO (single-key
    ...
    utxo_commitment: Hash64::from_bytes([0xde, 0xd9, 0x24, 0x4c, 0x70, 0x52, 0x46, 0x8c, 0x72, 0x0f, 0x5f, 0xc6, 0xee, 0x96, 0x10, 0x5f, 0xe6, 0xa6, 0x1f, 0xf0, 0x9f, 0x1b, 0xdf, 0x2d, 0xba, 0x4e, 0x7d, 0x0f, 0xe1, 0x68, 0x33, 0x89, 0x18, 0x50, 0x01, 0xe0, 0x11, 0xc2, 0xba, 0x2f, 0x86, 0x7a, 0xb7, 0xf1, 0x32, 0xe0, 0x59, 0x6b, 0xbb, 0x3e, 0xab, 0x28, 0x48, 0x60, 0x5e, 0xe9, 0xd9, 0xd3, 0x38, 0x1e, 0xb7, 0x19, 0x89, 0x8f]),
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([0x3c, 0xf2, 0xe1, 0xc6, 0x42, 0xb3, 0x57, 0x30, 0xb6, 0x1d, 0xd2, 0x46, 0xae, 0x80, 0x83, 0x0b, 0x47, 0x70, 0x82, 0x87, 0xdb, 0x46, 0x4c, 0x2d, 0x6c, 0x47, 0x89, 0xaf, 0xd3, 0xb5, 0x60, 0x7a, 0xed, 0x33, 0x3c, 0x5c, 0xa3, 0x61, 0x33, 0xc7, 0x18, 0x49, 0xbd, 0x06, 0x9a, 0x48, 0x8c, 0xb6, 0xb7, 0x15, 0xaa, 0x28, 0xcb, 0xe8, 0x4f, 0x79, 0x2b, 0xeb, 0x1c, 0x1d, 0x0d, 0x40, 0xe8, 0x9f]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
    ...
    // kaspa-pq: genesis commits to the 12B premine UTXO (single-key ML-DSA-87
    // P2PKH); = MuHash over `config::premine::misaka_premine_utxos()`. Same on all nets.
    utxo_commitment: Hash64::from_bytes([0x50, 0x1d, 0x08, 0xf4, 0x1d, 0x92, 0x92, 0x8b, 0x27, 0x25, 0x01, 0x34, 0x7f, 0x6e, 0x90, 0xee, 0xac, 0x53, 0x11, 0xf8, 0x2b, 0xae, 0x9e, 0xdf, 0xaf, 0x5b, 0x26, 0x79, 0x40, 0x9f, 0x28, 0xf6, 0xe3, 0xce, 0xce, 0xa0, 0xfe, 0x75, 0x65, 0x8d, 0x1a, 0xc2, 0xa2, 0x12, 0x33, 0x35, 0xb5, 0xef, 0x11, 0x0c, 0xf6, 0x51, 0xb6, 0x10, 0x81, 0xd6, 0xbc, 0x64, 0xbf, 0x03, 0xab, 0xa1, 0x68, 0x2d]),
    timestamp: 1748390400000,
    bits: 0x1e7fffff,
    nonce: 0,
    daa_score: 0,
...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([0x3e, 0x77, 0x72, 0x74, 0xa0, 0xbd, 0x81, 0xdf, 0xe5, 0xb2, 0xd3, 0xc2, 0xfe, 0x15, 0x7e, 0xa0, 0xb9, 0xd6, 0xce, 0xfb, 0xba, 0x80, 0xd7, 0xc2, 0x11, 0x68, 0xc1, 0xe5, 0x56, 0x48, 0x90, 0x28, 0x9d, 0xff, 0xa3, 0x50, 0x99, 0xab, 0x7c, 0x4a, 0xf9, 0x93, 0x06, 0xea, 0x0b, 0x4f, 0x18, 0xa0, 0x5f, 0x5c, 0x8d, 0xa0, 0x18, 0xb7, 0xa0, 0xf8, 0xe1, 0x6d, 0x75, 0x4d, 0xc8, 0xb2, 0x37, 0x40]),
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([0x45, 0xdd, 0xcc, 0x1d, 0x19, 0x61, 0x18, 0xa9, 0x97, 0x9e, 0xbc, 0x3e, 0xf9, 0x77, 0xc7, 0x27, 0x59, 0xcb, 0xc7, 0x8d, 0x7d, 0xea, 0x07, 0x17, 0x8a, 0x1a, 0xf1, 0x84, 0xd3, 0x2b, 0x98, 0x60, 0x5f, 0x6b, 0x64, 0x8b, 0x7b, 0x3a, 0x72, 0xb1, 0xcb, 0x2c, 0x5a, 0xb6, 0x53, 0xcb, 0x1e, 0x8a, 0x7a, 0x3b, 0x5f, 0x64, 0xce, 0x5b, 0xa5, 0xc1, 0x6b, 0xc5, 0x23, 0xff, 0x5d, 0xd4, 0xa7, 0x0e]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([0x69, 0xf0, 0x91, 0x91, 0xf0, 0x73, 0x07, 0x83, 0x2e, 0xa6, 0xca, 0xec, 0x5a, 0x38, 0xd3, 0xf6, 0xf5, 0x73, 0xc9, 0x63, 0xe0, 0x9a, 0x9b, 0x99, 0x9a, 0xd6, 0xfb, 0x3c, 0x4d, 0xd6, 0x98, 0x03, 0xe8, 0x13, 0x66, 0x24, 0x60, 0x19, 0xb1, 0x09, 0x37, 0x7d, 0x47, 0x8f, 0x9d, 0x38, 0x95, 0x77, 0xd0, 0x08, 0xfb, 0xbc, 0xa8, 0x24, 0xfd, 0x6b, 0x54, 0x56, 0xc9, 0x67, 0x13, 0x49, 0x42, 0x3e]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
