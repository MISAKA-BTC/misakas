...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    // MISAKA Phase 4 (PALW): recomputed for the rescaled trivial bits (payload unchanged, so the
    // merkle root is untouched) via `gen_kaspa_pq_genesis_hashes`.
    hash: Hash64::from_bytes([
        0x93, 0xb7, 0xa1, 0xce, 0x4a, 0x19, 0x17, 0x25, 0x41, 0x7d, 0x3f, 0x2b, 0x23, 0xe6, 0x94, 0x23, 0x5f, 0x26, 0x21, 0xcb, 0x15,
        0xcd, 0x3e, 0xbc, 0xad, 0x8b, 0x41, 0x24, 0x45, 0x71, 0x0f, 0x6c, 0xad, 0xe5, 0x4b, 0x95, 0x24, 0x09, 0x7c, 0x66, 0x01, 0x82,
        0x75, 0x0e, 0x34, 0xde, 0x45, 0xb4, 0xcb, 0x4c, 0x7b, 0xda, 0xd1, 0x31, 0xed, 0x0d, 0x32, 0xb1, 0x95, 0x1f, 0xda, 0x2a, 0x76,
        0x12,
    ]),
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
