...
pub const GENESIS: GenesisBlock = GenesisBlock {
    ...
    hash: Hash64::from_bytes([
        0xf8, 0x2d, 0x7d, 0xf0, 0xfa, 0x39, 0x62, 0xe2, 0x1f, 0xd2, 0xf4, 0x9f, 0xd4, 0xb7, 0xd7, 0x11, 0x65, 0x94, 0x4d, 0xf6, 0x2a,
        0x04, 0xb3, 0x53, 0x62, 0x7a, 0xca, 0x41, 0xe5, 0xef, 0x50, 0xf9, 0x79, 0xfb, 0x21, 0x61, 0x65, 0x4e, 0xb2, 0x2b, 0x53, 0x28,
        0x27, 0xf2, 0x60, 0xb0, 0x54, 0xdc, 0x81, 0x72, 0xc6, 0x1a, 0x4b, 0xd4, 0x04, 0x0c, 0xa5, 0x74, 0x81, 0xa2, 0x6e, 0xbc, 0x71,
        0xa5,
    ]),
    version: 0,
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xd0, 0x14, 0xa9, 0x20, 0x8d, 0x61, 0x8f, 0xaf, 0x6d, 0x03, 0xa6, 0x02, 0x68, 0x81, 0x1d, 0x0c, 0x01, 0xdc, 0xb1, 0x3a, 0xc3,
        0xfb, 0x04, 0x7d, 0x83, 0x74, 0x41, 0x3a, 0xaa, 0x5b, 0xc8, 0x1d, 0xa7, 0xf3, 0x57, 0xf7, 0x8c, 0x6d, 0x60, 0x7a, 0x02, 0x72,
        0xe2, 0xf9, 0x2f, 0x20, 0x8d, 0xcf, 0x52, 0x6e, 0x09, 0xe4, 0x79, 0x24, 0xbd, 0x4d, 0xb7, 0x18, 0x37, 0xce, 0x36, 0xb9, 0x53,
        0xbc,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xe4, 0x40, 0x47, 0x11, 0x2c, 0xbc, 0xa3, 0xce, 0xf9, 0x1e, 0x9b, 0x05, 0x28, 0x13, 0xf1, 0x5b, 0xf8, 0xed, 0x90, 0xca, 0x13,
        0x92, 0x0b, 0xa3, 0x0f, 0x51, 0x2d, 0x54, 0x69, 0xc9, 0x7d, 0xed, 0x83, 0x0e, 0xa0, 0xaa, 0x27, 0xa6, 0xa5, 0x46, 0x51, 0x15,
        0xa5, 0x0e, 0x9e, 0x14, 0x80, 0x53, 0xf6, 0xa0, 0x7a, 0xf2, 0x9a, 0xce, 0xb7, 0xd0, 0x73, 0x58, 0x9b, 0x78, 0x05, 0xb5, 0xef,
        0xb0,
    ]),
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x0b, 0x31, 0x90, 0x27, 0x98, 0x7d, 0x01, 0x09, 0xd3, 0xc5, 0x56, 0xfd, 0xf8, 0x61, 0x78, 0xcb, 0x69, 0x92, 0x27, 0x8d, 0x86,
        0xe6, 0x42, 0xa5, 0x84, 0x7a, 0xb5, 0x6f, 0x1f, 0xd3, 0xfe, 0xd4, 0xd1, 0xc8, 0x74, 0xe3, 0x6a, 0x47, 0x34, 0x7f, 0x84, 0x65,
        0x4b, 0x57, 0x94, 0xc3, 0x0e, 0xfd, 0x3a, 0x55, 0xd9, 0x34, 0x0a, 0x35, 0xb2, 0x4c, 0xb8, 0x2b, 0xe7, 0xfa, 0x48, 0x2d, 0x39,
        0x61,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x08, 0xfc, 0xc9, 0x72, 0xad, 0xd4, 0x65, 0xea, 0xd9, 0xbf, 0xfc, 0xa2, 0x1f, 0xcb, 0x11, 0x20, 0x45, 0xf3, 0xaa, 0xac, 0xac,
        0x28, 0xdc, 0xae, 0x01, 0x26, 0x97, 0x86, 0x4c, 0x43, 0x8b, 0xa8, 0x24, 0xc6, 0xfa, 0xa8, 0x3c, 0x3f, 0x92, 0x87, 0xfe, 0x4c,
        0x63, 0xfa, 0xed, 0x6e, 0x8d, 0x44, 0x60, 0x43, 0x66, 0xd1, 0xe4, 0x06, 0x31, 0xdb, 0xf1, 0x5b, 0xcd, 0x36, 0xad, 0xb0, 0x41,
        0x2c,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
