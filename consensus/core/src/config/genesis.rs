...
pub const GENESIS: GenesisBlock = GenesisBlock {
    ...
    hash: Hash64::from_bytes([
        0x74, 0xec, 0xef, 0x3d, 0x4a, 0x43, 0xe8, 0x49, 0xaa, 0x4a, 0xcc, 0xe4, 0x30, 0x30, 0x2c, 0x1a, 0x54, 0x85, 0x38, 0x51, 0x3b,
        0x22, 0xbb, 0x4e, 0xcc, 0xbb, 0x44, 0x33, 0x3d, 0xe6, 0x5e, 0xcd, 0xf7, 0x35, 0x2c, 0x81, 0xee, 0x52, 0x9b, 0x03, 0x78, 0x9e,
        0x9c, 0x3f, 0x26, 0xce, 0x01, 0xfe, 0x47, 0x5f, 0xab, 0x00, 0x3d, 0xf1, 0x52, 0x1f, 0x3d, 0xe5, 0x66, 0x5e, 0xfa, 0xf0, 0xbd,
        0xe9,
    ]),
    version: 0,
    ...
    utxo_commitment: Hash::from_bytes([
        0xea, 0x34, 0x01, 0x0e, 0x98, 0x6f, 0x9a, 0x2b, 0x30, 0x29, 0x21, 0x52, 0x71, 0xab, 0x0e, 0xd5, 0x4d, 0xa4, 0x08, 0x78, 0x06,
        0x18, 0x4d, 0xc6, 0x9a, 0x48, 0x88, 0xaa, 0x51, 0x72, 0x8d, 0x7d,
    ]),
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xac, 0x4c, 0xa5, 0x07, 0xc3, 0x6e, 0xbc, 0x8d, 0x27, 0x82, 0x2d, 0x26, 0x37, 0x51, 0x97, 0x01, 0x5c, 0x1a, 0x21, 0xf4, 0xea,
        0xb3, 0xa3, 0xd0, 0x8d, 0x3c, 0xfe, 0xeb, 0x65, 0x1f, 0xa4, 0x8e, 0x56, 0x71, 0x36, 0xaa, 0x81, 0x56, 0xda, 0xb3, 0xa1, 0x35,
        0xfa, 0x38, 0xd5, 0x02, 0x16, 0x8b, 0xd2, 0x37, 0xd3, 0xb3, 0x7a, 0xbb, 0x5c, 0x6a, 0xf0, 0xa3, 0x0a, 0x69, 0xd9, 0x23, 0xfc,
        0xd9,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
...
pub const TESTNET11_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0xa5, 0x3e, 0x55, 0xdf, 0xc4, 0x05, 0x02, 0x80, 0x13, 0x17, 0x11, 0x72, 0x92, 0x30, 0xbd, 0xa9, 0xc0, 0xc4, 0xb2, 0x1a, 0x48,
        0x8c, 0xa7, 0x09, 0x2e, 0xf2, 0xee, 0xff, 0xaa, 0x55, 0xf8, 0x99, 0x6a, 0x20, 0x81, 0x2f, 0xe8, 0x11, 0xa7, 0x09, 0xca, 0x45,
        0xae, 0x0b, 0x52, 0x5d, 0x77, 0x31, 0xb2, 0xe0, 0xb8, 0x62, 0xdf, 0x07, 0xad, 0xe2, 0x4e, 0x54, 0xf0, 0xaa, 0x81, 0xd3, 0x37,
        0x8a,
    ]),
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
    hash_merkle_root: Hash64::from_bytes([
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x24, 0xbd, 0xac, 0xe0, 0xa7, 0x64, 0x17, 0x0e, 0xa4, 0x5c, 0x53, 0x77, 0x69, 0xf7, 0x01, 0x60, 0xef, 0x92, 0xd2, 0x6c, 0x3c,
        0x00, 0xdf, 0x9e, 0x60, 0xf1, 0x3d, 0xac, 0x59, 0x8f, 0x11, 0xdc, 0xed, 0xc0, 0xa3, 0x7d, 0x21, 0xb3, 0x50, 0x4b, 0xc8, 0x28,
        0xeb, 0xd3, 0x2e, 0xa7, 0x1c, 0xee, 0x80, 0x0a, 0xe9, 0x9f, 0x9d, 0xc3, 0x5a, 0xf6, 0xde, 0x16, 0x94, 0x01, 0xa6, 0x2b, 0x5e,
        0x2f,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash64::from_bytes([
        0x7c, 0x0c, 0x39, 0x37, 0xcb, 0xd6, 0xd2, 0xb9, 0x44, 0x81, 0x0f, 0x90, 0x58, 0x18, 0x31, 0xe0, 0x25, 0x9b, 0x85, 0x83, 0x4b,
        0x4d, 0xc8, 0xcb, 0xba, 0xb6, 0xa0, 0x8c, 0x68, 0x4b, 0x75, 0x31, 0x60, 0x36, 0x4f, 0x82, 0x34, 0xe6, 0xd0, 0xc4, 0x40, 0x43,
        0xa1, 0xdf, 0xff, 0xf9, 0xa7, 0x9a, 0xc1, 0x88, 0x44, 0x37, 0x54, 0xbc, 0xbf, 0xa9, 0x25, 0xba, 0x84, 0x43, 0xb6, 0xd3, 0x32,
        0xf2,
    ]),
    version: 0,
    // PR-9.5g: recomputed (64-byte Hash64) via `gen_kaspa_pq_genesis_hashes`.
