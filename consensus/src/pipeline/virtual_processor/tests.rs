...
async fn palw_rc_qwen36_per_epoch_expected_observed_target() {
    use kaspa_consensus_core::api::ConsensusApi;
    use kaspa_consensus_core::palw_attempt_v2::{
        attempt_id_v2, challenge_v2, class_ticket_v2, palw_network_domain_v2, PalwAttemptEnvelopeV2, PalwAttemptUnsignedV2,
        PALW_ATTEMPT_V2_MLDSA87_CONTEXT, PALW_ATTEMPT_V2_VERSION,
    };
    use kaspa_consensus_core::palw_backend::PalwExecutionBackendV1;
    use kaspa_consensus_core::palw_base0_profile::{base0_profile_v1, PALW_RC_BASE0_CANONICAL, PALW_RC_BASE0_GEOMETRY};
    use kaspa_consensus_core::palw_qwen36_profile::{qwen36_profile_v1, QWEN36_35B_A3B, QWEN36_RC_CANONICAL};
    use misaka_palw_base0::produce::{base0_execute_for_attempt_v1, base0_rc_job_anchor_v1, base0_rc_job_v1};
    use misaka_palw_base0::qwen36_backend::Qwen36Backend;
