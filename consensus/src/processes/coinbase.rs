...
/*
    ...
    Tokenomics: 18B KAS of additional issuance over 20 years, decaying at a
    5%/year exponential rate (q = 0.95), on top of a 12B genesis premine for a
    30B final supply. (Rebalanced from 15B premine + 15B issuance: 3B moved from
    the premine to network emission.) The schedule steps once per year (12
    identical months), so the table holds 20 yearly rates × 12 months = 240
    entries followed by a terminal 0 (issuance ends after year 20).
    ...
    `E_1 = 18e9 · (1 - 0.95) / (1 - 0.95^20) ≈ 1.402931021e9 KAS`. This yields
    ≈ 4.44562 KAS/block in year 1 at 10 BPS and a 20-year total of ≈ 18B KAS.
...
const SUBSIDY_BY_MONTH_TABLE: [u64; SUBSIDY_BY_MONTH_TABLE_SIZE] = [
    4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4445620140, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4223339133, 4012172176,
    4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 4012172176, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3811563567, 3620985389, 3620985389,
    3620985389, 3620985389, 3620985389, 3620985389, 3620985389, 3620985389, 3620985389, 3620985389, 3620985389, 3620985389, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3439936119, 3267939314, 3267939314, 3267939314,
    3267939314, 3267939314, 3267939314, 3267939314, 3267939314, 3267939314, 3267939314, 3267939314, 3267939314, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 3104542348, 2949315230, 2949315230, 2949315230, 2949315230,
    2949315230, 2949315230, 2949315230, 2949315230, 2949315230, 2949315230, 2949315230, 2949315230, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2801849469, 2661756995, 2661756995, 2661756995, 2661756995, 2661756995,
    2661756995, 2661756995, 2661756995, 2661756995, 2661756995, 2661756995, 2661756995, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2528669146, 2402235688, 2402235688, 2402235688, 2402235688, 2402235688, 2402235688,
    2402235688, 2402235688, 2402235688, 2402235688, 2402235688, 2402235688, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2282123904, 2168017709, 2168017709, 2168017709, 2168017709, 2168017709, 2168017709, 2168017709,
    2168017709, 2168017709, 2168017709, 2168017709, 2168017709, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 2059616823, 1956635982, 1956635982, 1956635982, 1956635982, 1956635982, 1956635982, 1956635982, 1956635982,
    1956635982, 1956635982, 1956635982, 1956635982, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1858804183, 1765863974, 1765863974, 1765863974, 1765863974, 1765863974, 1765863974, 1765863974, 1765863974, 1765863974,
    1765863974, 1765863974, 1765863974, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 1677570775, 0,
];
...
mod tests {
    ...
    /// Verifies the kaspa-pq additional-issuance schedule sums to ~18B KAS over
    ...
    fn verify_total_emission() {
        ...
        const TARGET_KAS: u128 = 18_000_000_000;
        let delta_kas = TARGET_KAS as i128 - total_kas as i128;
        assert!(delta_kas.abs() <= 1, "additional issuance {total_kas} KAS deviates from 18B by {delta_kas} KAS");
        // The clean 1 BPS figure stays within the 18B budget; the live network adds
        // only the small div_ceil rounding surplus checked below.
        assert!(total_kas <= TARGET_KAS, "additional issuance {total_kas} KAS exceeds the 18B budget");
    ...
    #[test]
    fn subsidy_test() {
        // Year-1 per-block subsidy at 10 BPS = table[0].div_ceil(10) ≈ 4.44562 KAS.
        const YEAR1_PER_BLOCK_10BPS: u64 = 444562014;
