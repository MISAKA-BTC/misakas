...
/// **ADR-0111 Decision 2: a leaf-evidence request's signed message** — the interval request's
...
/// Sign a leaf-evidence request with the bond's key (ADR-0111 Decision 2).
...
mod tests {
    ...
    fn roots() -> PalwClaimRootsV1 {
        PalwClaimRootsV1 { execution_root: h(4), trace_root: h(5), anchor: h(9), attempt_draw: None, output_root: None, job_pin: None }
    }
    ...
    /// **ADR-0111 Decision 2: a leaf request signs its leaf, and is neither another leaf's request
