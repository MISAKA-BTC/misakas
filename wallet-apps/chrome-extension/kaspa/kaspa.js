 ...
 * @category Wallet SDK
 * @param {Transaction} tx
 * @param {KaspaPqKeyPair} keypair
 * @param {Uint8Array} randomness
 * @returns {Transaction}
 */
export function signTransactionMlDsa87(tx, keypair, randomness) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        _assertClass(tx, Transaction);
        _assertClass(keypair, KaspaPqKeyPair);
        const ptr0 = passArray8ToWasm0(randomness, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        wasm.signTransactionMlDsa87(retptr, tx.__wbg_ptr, keypair.__wbg_ptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
...
export const AddressVersion = Object.freeze({
     ...
     */
    PubKeyHashMlDsa87: 2, "2": "PubKeyHashMlDsa87",
    /**
...
const Hash64Finalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hash64_free(ptr >>> 0, 1));
/**
...
export class Hash64 {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Hash64.prototype);
        obj.__wbg_ptr = ptr;
        Hash64Finalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        Hash64Finalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_hash64_free(ptr, 0);
    }
    /**
     * @param {string} hex_str
     */
    constructor(hex_str) {
        const ptr0 = passStringToWasm0(hex_str, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.hash64_constructor(ptr0, len0);
        this.__wbg_ptr = ret >>> 0;
        Hash64Finalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @returns {string}
    ...
    toString() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.hash64_toString(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
...
const KaspaPqKeyPairFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_kaspapqkeypair_free(ptr >>> 0, 1));
/**
...
export class KaspaPqKeyPair {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(KaspaPqKeyPair.prototype);
        obj.__wbg_ptr = ptr;
        KaspaPqKeyPairFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        KaspaPqKeyPairFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_kaspapqkeypair_free(ptr, 0);
    }
    /**
     * 1952-byte ML-DSA-65 public key.
     * @returns {MlDsa87PublicKey}
     */
    publicKey() {
        const ret = wasm.kaspapqkeypair_publicKey(this.__wbg_ptr);
        return MlDsa87PublicKey.__wrap(ret);
    }
    /**
     ...
     * @param {number} change
     * @param {number} index
     * @returns {KaspaPqKeyPair}
     */
    static fromMnemonic(phrase, passphrase, network_id, account, change, index) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(phrase, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passStringToWasm0(passphrase, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len1 = WASM_VECTOR_LEN;
            const ptr2 = passStringToWasm0(network_id, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len2 = WASM_VECTOR_LEN;
            wasm.kaspapqkeypair_fromMnemonic(retptr, ptr0, len0, ptr1, len1, ptr2, len2, account, change, index);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            return KaspaPqKeyPair.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    sign(message, randomness) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ptr1 = passArray8ToWasm0(randomness, wasm.__wbindgen_export_1);
            const len1 = WASM_VECTOR_LEN;
            wasm.kaspapqkeypair_sign(retptr, this.__wbg_ptr, ptr0, len0, ptr1, len1);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            return MlDsa87Signature.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
     ...
     * `misakadev`).
     * @param {string} network_prefix
     * @returns {Address}
     */
    address(network_prefix) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(network_prefix, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.kaspapqkeypair_address(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    static fromSeed(seed) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.kaspapqkeypair_fromSeed(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
...
const MlDsa87PublicKeyFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mldsa87publickey_free(ptr >>> 0, 1));
/**
 * 1952-byte ML-DSA-65 public key, WASM-facing newtype.
 */
export class MlDsa87PublicKey {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(MlDsa87PublicKey.prototype);
        obj.__wbg_ptr = ptr;
        MlDsa87PublicKeyFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MlDsa87PublicKeyFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mldsa87publickey_free(ptr, 0);
    }
    /**
    ...
    static fromBytes(bytes) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.mldsa87publickey_fromBytes(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
            ...
            return MlDsa87PublicKey.__wrap(r0);
        } finally {
            wasm.__wbindgen_add_to_stack_pointer(16);
        }
    }
    ...
    toHex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mldsa87publickey_toHex(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    static fromHex(hex) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.mldsa87publickey_fromHex(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    toBytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mldsa87publickey_toBytes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
const MlDsa87SignatureFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mldsa87signature_free(ptr >>> 0, 1));
/**
 * 3309-byte ML-DSA-65 signature, WASM-facing newtype.
 */
export class MlDsa87Signature {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(MlDsa87Signature.prototype);
        obj.__wbg_ptr = ptr;
        MlDsa87SignatureFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MlDsa87SignatureFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mldsa87signature_free(ptr, 0);
    }
    /**
     * @param {Uint8Array} bytes
     * @returns {MlDsa87Signature}
    ...
    static fromBytes(bytes) {
        try {
            ...
            const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_export_1);
            const len0 = WASM_VECTOR_LEN;
            wasm.mldsa87signature_fromBytes(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    toHex() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mldsa87signature_toHex(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
     ...
     * @param {MlDsa87PublicKey} public_key
     * @param {Uint8Array} message
     * @returns {boolean}
     */
    verify(public_key, message) {
        _assertClass(public_key, MlDsa87PublicKey);
        const ptr0 = passArray8ToWasm0(message, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.mldsa87signature_verify(this.__wbg_ptr, public_key.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {string} hex
    ...
    static fromHex(hex) {
        try {
            ...
            const ptr0 = passStringToWasm0(hex, wasm.__wbindgen_export_1, wasm.__wbindgen_export_2);
            const len0 = WASM_VECTOR_LEN;
            wasm.mldsa87signature_fromHex(retptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
            if (r2) {
    ...
    toBytes() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.mldsa87signature_toBytes(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var v1 = getArrayU8FromWasm0(r0, r1).slice();
            wasm.__wbindgen_export_3(r0, r1 * 1, 1);
...
export class TransactionOutpoint {
    ...
    /**
     * @param {Hash64} transaction_id
     * @param {number} index
     */
    constructor(transaction_id, index) {
        _assertClass(transaction_id, Hash64);
...
export class TransactionRecord {
    ...
    get id() {
        ...
        return Hash64.__wrap(ret);
    }
    /**
     * @param {Hash64} arg0
     */
    set id(arg0) {
        _assertClass(arg0, Hash64);
        var ptr0 = arg0.__destroy_into_raw();
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_hash64_new = function(arg0) {
        const ret = Hash64.__wrap(arg0);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper874 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 245, __wbg_adapter_66);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper8741 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 2910, __wbg_adapter_75);
        return addHeapObject(ret);
    };
